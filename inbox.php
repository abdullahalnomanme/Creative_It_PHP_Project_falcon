...
// $select_message_query = "SELECT * FROM contact_messages";
// $data_from_db = mysqli_query($db_connect, $select_message_query);
...
if(isset($_GET['contact_id'])){
    ...
    $select_message_query = "UPDATE contact_messages SET delete_status = 1 WHERE id=$contact_id";
                ...
                <div class="col-12">
                    <div class="card mb-5">
                        <div class="card-header bg-success text-white">
                            ...
                            <span class="pull-left text-uppercase p-2" >Contact Message</span>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php if($contact_message['delete_status'] == 1):?>
                                    <tr class="<?php if($contact_message['message_status'] == 2):?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button value="recyclebin.php?contact_id=<?= $contact_message['id']?>&delete_type=single" type="button" class="btn btn-danger delete_btn"><i class="icon ion-trash-b"></i></button> 
                                                
                                                <?php if($contact_message['message_status'] == 2):?>
                                                    <a title="Make Unread" href="contact_unread.php?contact_id=<?= $contact_message['id']?>" type="button" class="btn btn-warning"><i class="fa fa-eye-slash"></i></a>
                                                <?php endif;?>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="card-footer text-center bg-success text-white">
                            <?php
                                $select_message_query = "SELECT * FROM contact_messages WHERE delete_status =1 ORDER BY id DESC";
...
$(document).ready(function(){
    $(".delete_btn").click(function(){
        var delete_btn_value = $(this).val();
        Swal.fire({
            title: 'Do you want to delete or Trash this message?',
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = delete_btn_value;
            } else if (result.isDenied) {
                Swal.fire('Trash this message', '', 'success');
                window.location.href = "contact_delete.php?contact_id=<?= $contact_message['id']?>&delete_type=single";
            }
        });
    });
});
